...
import { Completedorder } from "../Api/User";
...
const Completedorder_ = () => {
  ...
  const getalldata = async () => {
    ...
    var myorderdata = await Completedorder({ id: store_id });
    setrows(myorderdata);
  };
  const exportoption = () => {
    var exportdata = [];
    ...
    XLSX.writeFile(wb, "completeorder.xlsx");
  };
  // drawer
    ...
    <div className="flex ">
      ...
      <div>
        ...
        <div className="col-span-2 p-8 Products">
          <div className="flex ">
            <h1 className=" p-3 mr-4 mb-4 ">Completed Orders</h1>
            {rows.length !== 0 ? (
              <button
...
export default Completedorder_;
